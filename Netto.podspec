#
#  Be sure to run `pod spec lint NettoPodSpec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Netto"
  s.version      = "0.0.1"
  s.summary      = "Lightweight network library in Swift"
  ...
  s.source       = { :git => "http://github.com/narup/Netto.git", :tag => "0.0.1" }
  ...
  s.source_files  = "Netto/Source/*.swift"
